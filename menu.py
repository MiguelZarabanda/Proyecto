...
ahorcado_button = Button(white, 100, 100, 200, 50, 'Ahorcado')
buscaminas_button = Button(white, 500, 100, 200, 50, 'Buscaminas')
facil_button = Button(white, 100, 300, 200, 50, 'Facil')
medio_button = Button(white, 300, 300, 200, 50, 'Medio')
dificil_button = Button(white, 500, 300, 200, 50, 'Dificil')
